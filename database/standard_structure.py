...
from database.sql import insert_standard_structure_sql, standard_system_table_schema,insert_standard_system_sql,standard_system_select_sql,CREATE_TABLE_STANDARD_STRUCTURE
