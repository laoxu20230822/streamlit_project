...
def display_metric_query_list(search_term: str):
    ...
    grid_options = {
        ...
        "columnDefs": [
            ...
            {"field": "unit", "headerName": "计量单位", "width": 60},
            {"field": "indicator_requirement", "headerName": "指标要求", "width": 100},
            {"field": "experimental_condition", "headerName": "试验条件", "width": 150},
            {
            ...
            {"field": "remarks", "headerName": "备注", "width": 100},
            {
                "field": "standard_info",
                "headerName": "标准来源",
                "wrapText": True,
            ...
            {"field": "purpose", "headerName": "用途", "hide": True},
        ],
        "rowSelection": {
            "mode": "singleRow",
            "checkboxes": False,
