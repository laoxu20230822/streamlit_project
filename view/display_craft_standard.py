...
def display_craft_standard(standard_code):
    ...
    event = st.dataframe(
        ...
        column_config={
            ...
            "parameter": st.column_config.TextColumn("参数", help="参数"),
            "method1": st.column_config.TextColumn(
                "方法1(1计算方法/2录取方法)", help="方法1(1计算方法/2录取方法)"
            ),
            "method2": st.column_config.TextColumn("方法2", help="方法2"),
            ...
            "process_tech1": st.column_config.TextColumn("工艺技术1", help="工艺技术1"),
            "process_tech2": st.column_config.TextColumn("工艺技术2", help="工艺技术2"),
            "process_tech3": st.column_config.TextColumn("工艺技术3", help="工艺技术3"),
        },
    )
