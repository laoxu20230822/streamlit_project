...
def display_standard_glossary(standard_code: str):
    ...
    event = st.dataframe(
        ...
        width="stretch",
        column_config={
            "term": st.column_config.TextColumn("术语词条", help="术语词条"),
            "english_term": st.column_config.TextColumn("术语英文", help="术语英文"),
            "definition": st.column_config.TextColumn("术语定义", help="术语定义"),
